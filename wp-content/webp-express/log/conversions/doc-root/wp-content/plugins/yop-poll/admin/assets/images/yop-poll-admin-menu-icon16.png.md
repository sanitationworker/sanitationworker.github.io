WebP Express 0.17.2. Conversion triggered with the conversion script (wod/webp-on-demand.php), 2019-11-12 02:04:25
...
Destination folder does not exist. Creating folder: [doc-root]/wp-content/webp-express/webp-images/doc-root/wp-content/plugins/yop-poll/admin/assets/images

Options:
------------
The following options have been set explicitly. Note: it is the resulting options after merging down the "jpeg" and "png" options and any converter-prefixed options.
- source: [doc-root]/wp-content/plugins/yop-poll/admin/assets/images/yop-poll-admin-menu-icon16.png
- destination: [doc-root]/wp-content/webp-express/webp-images/doc-root/wp-content/plugins/yop-poll/admin/assets/images/yop-poll-admin-menu-icon16.png.webp
...
Converted image in 183 ms, reducing file size with 39% (went from 587 bytes to 360 bytes)
