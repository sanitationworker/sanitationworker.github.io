...
Destination folder does not exist. Creating folder: [doc-root]/wp-content/webp-express/webp-images/doc-root/wp-content/plugins/wpdiscuz/assets/img/plugin-icon

Options:
------------
The following options have been set explicitly. Note: it is the resulting options after merging down the "jpeg" and "png" options and any converter-prefixed options.
- source: [doc-root]/wp-content/plugins/wpdiscuz/assets/img/plugin-icon/plugin-icon-48.png
- destination: [doc-root]/wp-content/webp-express/webp-images/doc-root/wp-content/plugins/wpdiscuz/assets/img/plugin-icon/plugin-icon-48.png.webp
...
Converted image in 88 ms, reducing file size with 86% (went from 4234 bytes to 574 bytes)
