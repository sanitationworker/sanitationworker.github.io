...
Destination folder does not exist. Creating folder: [doc-root]/wp-content/webp-express/webp-images/doc-root/wp-content/plugins/wpdiscuz/assets/addons/user-mention

Options:
------------
The following options have been set explicitly. Note: it is the resulting options after merging down the "jpeg" and "png" options and any converter-prefixed options.
- source: [doc-root]/wp-content/plugins/wpdiscuz/assets/addons/user-mention/header.png
- destination: [doc-root]/wp-content/webp-express/webp-images/doc-root/wp-content/plugins/wpdiscuz/assets/addons/user-mention/header.png.webp
...
Converted image in 442 ms, reducing file size with 82% (went from 31 kb to 6 kb)
