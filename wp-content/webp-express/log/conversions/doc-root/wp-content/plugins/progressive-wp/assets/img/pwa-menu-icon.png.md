WebP Express 0.17.2. Conversion triggered with the conversion script (wod/webp-on-demand.php), 2019-11-15 14:23:21
...
Destination folder does not exist. Creating folder: [doc-root]/wp-content/webp-express/webp-images/doc-root/wp-content/plugins/progressive-wp/assets/img

Options:
------------
The following options have been set explicitly. Note: it is the resulting options after merging down the "jpeg" and "png" options and any converter-prefixed options.
- source: [doc-root]/wp-content/plugins/progressive-wp/assets/img/pwa-menu-icon.png
- destination: [doc-root]/wp-content/webp-express/webp-images/doc-root/wp-content/plugins/progressive-wp/assets/img/pwa-menu-icon.png.webp
...
Converted image in 92 ms, reducing file size with 76% (went from 1621 bytes to 384 bytes)
